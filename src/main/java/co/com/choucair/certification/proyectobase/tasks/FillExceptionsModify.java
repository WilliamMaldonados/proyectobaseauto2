...
import static co.com.choucair.certification.proyectobase.userinterface.FormExceptions.F3a_BTN_SAVE;
import static net.serenitybdd.screenplay.matchers.WebElementStateMatchers.isCurrentlyVisible;

public class FillExceptionsModify implements Task {
    private Map<String,String> data;

    public FillExceptionsModify(Map<String,String> data){this.data=data;}

    public static FillExceptionsModify declare (Map<String,String> data){return Tasks.instrumented(FillExceptionsModify.class,data);
    }
    ...
    public <T extends Actor> void performAs(T actor) {
        actor.attemptsTo(
                ...
                Click.on(F3a_BTN_CALENDAR),
                Click.on(F3a_DATA_PICKER),
                Enter.theValue(data.get("F3a_INPUT_NUMBER_MOD")).into(F3a_INPUT_NUMBER_MOD),
