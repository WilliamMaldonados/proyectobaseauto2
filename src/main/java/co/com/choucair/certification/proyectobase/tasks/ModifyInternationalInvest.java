...
public class ModifyInternationalInvest implements Task {

    private Map<String,String> data;

    public ModifyInternationalInvest(Map<String,String> data){this.data=data;}

    public static ModifyInternationalInvest declare (Map<String,String> data){return Tasks.instrumented(ModifyInternationalInvest.class,data);
    ...
    public <T extends Actor> void performAs(T actor) {
        actor.attemptsTo(
                ...
                Click.on(F4_BTN_CALENDAR),
                Click.on(F4_DATA_PICKER),
                Enter.theValue(data.get("F4_INPUT_NUMBER_MOD")).into(F4_INPUT_NUMBER_MOD),
