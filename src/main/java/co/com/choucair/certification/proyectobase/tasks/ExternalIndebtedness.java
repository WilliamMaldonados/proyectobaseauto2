...
public class ExternalIndebtedness implements Task {

    private Map<String,String> data;

    public ExternalIndebtedness(Map<String,String> data){this.data=data;}

    public static ExternalIndebtedness declare (Map<String,String> data){return Tasks.instrumented(ExternalIndebtedness.class,data);
    }
