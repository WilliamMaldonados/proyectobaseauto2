...
import static co.com.choucair.certification.proyectobase.userinterface.FormExternalIndebtednessPage.F3_BTN_SAVE;
import static net.serenitybdd.screenplay.matchers.WebElementStateMatchers.isCurrentlyVisible;

public class ExternalIndebtnessDevolution implements Task {
    private Map<String,String> data;

    public ExternalIndebtnessDevolution(Map<String,String> data){this.data=data;}

    public static ExternalIndebtnessDevolution declare (Map<String,String> data){return Tasks.instrumented(ExternalIndebtnessDevolution.class,data);
    }
