...
public class InternationalInvestments implements Task {

    private Map<String,String> data;

    public InternationalInvestments(Map<String,String> data){this.data=data;}

    public static InternationalInvestments declare (Map<String,String> data){return Tasks.instrumented(InternationalInvestments.class,data);
