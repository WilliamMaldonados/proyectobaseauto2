...
public class ExportGoodsDevolution implements Task {



    private Map<String,String> data;

    public ExportGoodsDevolution(Map<String,String> data){this.data=data;}

    public static ExportGoodsDevolution declare (Map<String,String> data){return Tasks.instrumented(ExportGoodsDevolution.class,data);
    }
    @Override
