...
public class ImportsGoods implements Task {

private Map<String,String> data;

public ImportsGoods(Map<String,String> data){this.data=data;}

    public static ImportsGoods declare (Map<String,String> data){return Tasks.instrumented(ImportsGoods.class,data);
}
    ...
    actor.attemptsTo(
            ...
            Click.on(FormImportPage.F1_INFO_TYPE),
