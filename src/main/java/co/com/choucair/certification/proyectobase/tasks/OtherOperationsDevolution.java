...
public class OtherOperationsDevolution  implements Task {
    private Map<String,String> data;

    public OtherOperationsDevolution(Map<String,String> data){this.data=data;}

    public static OtherOperationsDevolution declare (Map<String,String> data){return Tasks.instrumented(OtherOperationsDevolution.class,data);
