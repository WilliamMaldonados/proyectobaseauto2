...
Feature: Declare to the Republic Bank an exceptions
  ...
  with type of operation modifications

  @DeclareExceptions
  Scenario Outline: Fill out the exceptions modify forms and formula 10 to generate the file that had to be sent to the Republic Bank
    ...
    When the user fills the form exceptions for modify
      |F3a_INPUT_NUMBER_MOD|F3a_NUMBER_LENDING_INPUT|F3a_CREDITOR_NAME_INPUT|F3a_INPUT_COIN_NEGOTIATION|F3a_INPUT_COIN_VALOR|F3a_NAME_INPUT|F3a_IDENTITY_INPUT|F3a_ADDRESS|F3a_TELEPHONE|F3a_EMAIL|
      |<F3a_INPUT_NUMBER_MOD>|<F3a_NUMBER_LENDING_INPUT>|<F3a_CREDITOR_NAME_INPUT>|<F3a_INPUT_COIN_NEGOTIATION>|<F3a_INPUT_COIN_VALOR>|<F3a_NAME_INPUT>|<F3a_IDENTITY_INPUT>|<F3a_ADDRESS>| <F3a_TELEPHONE>| <F3a_EMAIL>|
