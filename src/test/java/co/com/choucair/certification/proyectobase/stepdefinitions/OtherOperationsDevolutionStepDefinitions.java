...
public class OtherOperationsDevolutionStepDefinitions {
    ...
    public void that_the_user_is_logged_into_the_application_of_sucursal_virtual_empresas_and_declarations_of_change_hdc_other_operations_for_devolution() {
    ...
    public void the_user_fills_the_form_of_other_operations_for_devolution(DataTable data) {
        List<Map<String,String>> dataform= data.asMaps(String.class,String.class);
        theActorInTheSpotlight().attemptsTo(OtherOperationsDevolution.declare(dataform.get(0)));
    }
    @Then("the user see then form op is created successfully for devolution")
    public void the_user_see_then_form_op_is_created_successfully_for_devolution() {
